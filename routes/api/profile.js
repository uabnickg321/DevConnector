...
router.put(
  ...
  async (req, res) => {
    ...
    // Might be able to combine this destructuring with the newExp variable declaration ???
    ...
    try {
      ...
      // unshift is same as push, but goes to beginning
...
router.delete('/experience/:exp_id', auth, async (req, res) => {
  try {
    ...
    // Need to get correct expereicne to remove (Get remove Index)
